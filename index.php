...
<?php require_once 'app/includes.php'; ?>
<?php session_start() ?>
...
<head lang="fr">
	...
	<title>La montagne en été</title>
...
<!--HEADER-->
	...
	<div class="container-fluid cst-bloc-header">
		<div class="row">
			<div class="col-md-2">
				<?php include_once 'view/aside.php'; ?>
			</div>
			<div class="col-md-8">
